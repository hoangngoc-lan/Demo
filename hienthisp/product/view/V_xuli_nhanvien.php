  ...
  <div class="row">
    ...
    <section class="col-md-9 mt-5">
      <h1 class="text-center col-md-12">Chào mừng: <?php echo $user[0]['full_name'] ?></h1>
                 ...
                 <!-- Thêm nhân viên-->
                 <section>
 <form action="?controller=xuli_nhanvien&method=edit&id=<?php echo $_GET['id'] ?>" method="post" enctype="multipart/form-data">
...
<div class="modal-header">
    ...
    <label for="full_name" >Catolog_id</label>
    <input type="text"  class="form-control"  required  name="catolog_id" value="<?php echo $data_sanpham[0]['catolog_id'] ?>">
  ...
  <section class="form-group">
    ...
    <input type="text"  class="form-control"  required  name="name" value="<?php echo $data_sanpham[0]['name'] ?>">
  
    
  </section>
  <section class="form-group">
    <label >Price_sale</label>
    <input type="text" class="form-control"  required  name="price_sale" value="<?php echo $data_sanpham[0]['price_sale'] ?>">
  </section>
  <section class="form-group">
    <label   >Price</label>
    <input type="text"   class="form-control"  required  name="price" value="<?php echo $data_sanpham[0]['price'] ?>">
    
  </section>
  <section class="form-group">
    <label for="lv">Amount</label>
    <input  class="form-control"  required  name="amount" value="<?php echo $data_sanpham[0]['amount'] ?>">
  ...
  <section class="form-group">
    ...
    <input  class="form-control"  required  name="content" value="<?php echo $data_sanpham[0]['content'] ?>">
    
  </section>
   <section class="form-group">
   <button class="btn btn-success" type="submit" name="btn_edit" >Sửa sản phẩm</button>
  </section>
