...
<div id="panelss">
  ...
  <!-- quản lý nhân viên --->
    ...
    <h1 class="text-center col-md-12">Chào mừng: <?php echo $user[0]['full_name'] ?></h1>
         ...
         <button class="btn btn-success" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-user-plus"></i> Thêm Nhân viên</button>
...
<div class="modal-header">
  ...
  <section class="form-group">
    ...
    <input  class="form-control"  required id="lv" name="lv">
    
  </section>
   <section class="form-group">
   <button class="btn btn-success" type="submit" name="btn_add">thêm nhân viên</button>
  </section>
...
<section>
  ...
  <!-- hiển thị nhân viên-->
  <?php foreach ($admin_nhanvien as $key => $value) {?>
  <tbody>
    <tr>
